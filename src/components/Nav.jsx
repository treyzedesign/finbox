    ...
    <div>
      <nav className='bg-slate-900 text-white flex'>
        ...
        <div className='flex-auto lg:w-40 w-20 text-right py-6 '>
          <div className='px-4'>
            <span class="py-1.5 px-5 mr-2 inline  text-sm font-medium text-white focus:outline-none rounded-lg border border-gray-200 hover:bg-lime-500 ">Login</span>
            <BiMenu className='flex items-center text-4xl'/>
          </div>
        </div>
      </nav>
